        ...
        <div id="layerslider-wrapper">
            <div id="layerslider_loan_home" class="ls-wp-container fitvidsignore" style="width:1280px;height:600px;margin:0 auto;margin-bottom:0;">
                <div class="ls-slide" data-ls="duration:4000;transition2d:5;kenburnsscale:1.2;">
                    ...
                    <div style="top:140px;left:238px;font-weight:700;font-size:14px;line-height:22px;color:#e95a59;font-family:Lato;" class="ls-l" data-ls="offsetyin:-100lh;easingin:easeOutQuint;">FROM PRE APPROVAL TO PROPERTY</div>
                    ...
                    <a href="{{ $contactUrl }}" style="cursor:pointer;top:427px;left:160px;font-weight:700;color:#ffffff;font-family:Lato;font-size:14px;padding:14px 35px;background-color:#e95a59;text-decoration:none;border-radius:4px;" class="ls-l" data-ls="offsetyin:50px;delayin:200;easingin:easeOutQuint;hover:true;hoveropacity:0.7;">READ MORE</a>
                </div>
                <div class="ls-slide" data-ls="duration:4000;transition2d:5;kenburnsscale:1.2;">
                    ...
                    <a href="{{ domain_url('tax') }}" style="cursor:pointer;top:427px;left:795px;font-weight:700;color:#ffffff;font-family:Lato;font-size:14px;padding:14px 35px;background-color:#e95a59;text-decoration:none;border-radius:4px;" class="ls-l" data-ls="offsetyin:50px;delayin:200;easingin:easeOutQuint;hover:true;hoveropacity:0.7;">READ MORE</a>
                </div>
                <div class="ls-slide" data-ls="duration:4000;transition2d:5;kenburnsscale:1.2;">
                    ...
                    <a href="{{ $contactUrl }}" style="cursor:pointer;top:427px;left:158px;font-weight:700;color:#ffffff;font-family:Lato;font-size:14px;padding:14px 35px;background-color:#e95a59;text-decoration:none;border-radius:4px;" class="ls-l" data-ls="offsetyin:50px;delayin:200;easingin:easeOutQuint;hover:true;hoveropacity:0.7;">READ MORE</a>
                    <a href="{{ $contactUrl }}" style="cursor:pointer;top:427px;left:332px;font-weight:700;font-family:Lato;font-size:14px;padding:12px 33px;border:solid 2px #e95a59;color:#e95a59;background-color:#ffffff;text-decoration:none;border-radius:4px;" class="ls-l" data-ls="offsetyin:50px;delayin:200;easingin:easeOutQuint;">GET A QUOTE</a>
                </div>
            </div>
        </div>
    </div>
