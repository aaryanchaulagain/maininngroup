...
@section('content')
<div class="mb-4 flex justify-between"><h2 class="font-semibold">Articles</h2><a href="{{ route('admin.articles.create') }}" class="btn-primary bg-inn-navy text-white text-sm">+ Add</a></div>
        ...
        @foreach($articles as $a)
            <tr>
                ...
                <td class="px-4 py-3 text-right">
                    <a href="{{ route('admin.articles.edit', $a) }}" class="text-tax-teal hover:underline">Edit</a>
                    <span class="mx-2 text-slate-300">|</span>
                    <form method="POST" action="{{ route('admin.articles.destroy', $a) }}" class="inline" onsubmit="return confirm('Delete “{{ $a->title }}”? This cannot be undone.');">
                        @csrf
                        @method('DELETE')
